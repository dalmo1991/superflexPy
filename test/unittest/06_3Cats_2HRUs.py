...
class TestStructureElements(unittest.TestCase):
    ...
    def _read_inputs(self):
        ...
        data = pd.read_csv('{}/test/reference_results/06_3Cats_2HRUs/input.dat'.format(package_path), header = 6, sep = '\s+|,\s+|,', engine = 'python')
    ...
    def _read_outputs(self):
        self._superflex_output = pd.read_csv('{}/test/reference_results/06_3Cats_2HRUs/Results.csv'.format(package_path))
