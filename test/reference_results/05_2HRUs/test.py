...
chdir('/home/dalmo/Documents/BitBucket/superflexpy_aug2019/test/superflex_results/05_2HRUs/')
...
np.savetxt('Results.csv', X = output, delimiter = ',', header = 'Q_tot, Q_H1, E_FR_H1, S_FR_H1, Q_H2, E_UR_H2, S_UR_H2, S_FR_H2, S_SR_H2')