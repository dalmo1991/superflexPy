...
ax[1].plot(range(len(precipitation)), output_unit_1, color='blue', lw=2,
           label='Unit 1')
ax[1].plot(range(len(precipitation)), output_unit_2, color='red', lw=2,
           ls='--', label='Unit 2')
...
ax[1].plot(range(len(precipitation)), output['node-1'][0], color='blue', lw=2,
           label='node-1')
ax[1].plot(range(len(precipitation)), output['node-2'][0], color='red', lw=2,
           label='node-2')
ax[1].plot(range(len(precipitation)), output['node-3'][0], color='orange', lw=2,
           label='node-3')
